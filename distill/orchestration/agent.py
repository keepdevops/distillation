...
from .subprocess_runner import run_cmd, find_llama_cpp, parse_log_line as _parse_log_line
...
def main():
    ...
    if args.n_trials > 1:
        ...
        for _t in range(args.n_trials):
            ...
            _t_eval_cmd = [sys.executable, "-m", "distill.eval.perplexity", str(trial_dir)]
            if args.open:
